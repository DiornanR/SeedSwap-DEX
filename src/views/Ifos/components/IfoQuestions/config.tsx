...
const config = [
  {
    ...
    description: [
      <Trans>
        ...
        SEED up to the maximum commit limit, which is published along with the IFO voting proposal. The Private Sale has
        no participation fee.
      </Trans>,
      <Trans>
        In the Public Sale, everyone with an active SeedSwap DEX profile can commit. However the maximum amount of SEED
        users can commit, is equal to the number of iSEED they have.
      </Trans>,
      <>
        <Trans>Learn more about iSEED</Trans>
        <InlineLink ml="4px" external href="https://docs.seedswap.finance/products/ifo-initial-farm-offering/iseed">
          <Trans>here</Trans>
        </InlineLink>
      </>,
  ...
  },
  {
    ...
    description: [
      ...
      <Trans>Just remember you need an active SeedSwap DEX Profile in order to participate.</Trans>,
    ],
  },
  {
  ...
  },
  {
    ...
    description: [<Trans>The SEED from the participation fee will be burnt as part of the weekly token burn.</Trans>],
  },
  {
    title: <Trans>How can I get an achievement for participating in the IFO?</Trans>,
    description: [
      <Trans>You need to contribute a minimum of about 10 USD worth of SEED to either sale.</Trans>,
      <Trans>
    ...
    description: [
      ...
      <>
        ...
        <InlineLink
          ml="4px"
          external
          href="https://medium.com/seedswap/community-initial-farm-offering-cifo-the-new-ifo-subtype-ac1abacf66be"
        >
          <Trans>here</Trans>
        </InlineLink>
      </>,
