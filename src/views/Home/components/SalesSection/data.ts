...
export const swapSectionData = (t: TranslateFunction): SalesSectionProps => ({
  ...
  secondaryButton: {
    to: 'https://docs.seedswap.finance/',
    text: t('Learn'),
    external: true,
  },
  images: {
...
// bodyText: t('PancakeSwap makes it easy to make your crypto work for you.'),
  bodyText: t('SeedSwap DEX makes it easy to make your crypto work for you.'),
  reverse: true,
  primaryButton: {
    to: '/farms',
    text: t('Explore'),
  ...
  secondaryButton: {
    to: 'https://docs.seedswap.finance/products/yield-farming',
    text: t('Learn'),
    external: true,
  },
  images: {
...
export const cakeSectionData = (t: TranslateFunction): SalesSectionProps => ({
  ...
  headingText: t('SEED makes trees grow and our world be green.'),
  // bodyText: t(
  ...
  // ),
  bodyText: t(
    'SEED token is at the heart of the SeedSwap DEX ecosystem. Buy it, win it, farm it, spend it, stake it... heck, you can even vote with it!',
  ),
  reverse: false,
  primaryButton: {
  ...
  secondaryButton: {
    to: 'https://docs.seedswap.finance/tokenomics/seed',
    text: t('Learn'),
    external: true,
  },
