...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and SEED pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and SEED pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from SEED pool', data)
  }
