...
const BoosterTooltip = () => {
  ...
  return (
    <>
      {t(
        `Boost multiplier is calculated based on the staking conditions from both Farms and fixed-term SEED pool and will be automatically updated upon user actions.`,
      )}
      <LinkExternal
        href="https://docs.seedswap.finance/products/yield-farming/bseed/faq#how-are-the-bseed-multipliers-calculated"
        external
      >
        {t('Learn More')}
      </LinkExternal>
